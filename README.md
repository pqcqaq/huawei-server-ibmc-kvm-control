...
- Window-local USB HID keyboard input with ordered key pulses for fast typing, held-key repeat, modifiers, lock keys, and special combinations; plus absolute, relative, and captured mouse modes with explicit pointer visibility and synchronization.
