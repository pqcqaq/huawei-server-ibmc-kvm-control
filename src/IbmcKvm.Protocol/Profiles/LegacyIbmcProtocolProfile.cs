...
public sealed class LegacyIbmcProtocolProfile : IKvmProtocolProfile
{
    public static LegacyIbmcProtocolProfile Instance { get; } = new();

    private LegacyIbmcProtocolProfile()
    {
    }

    public KvmProtocolKind Kind => KvmProtocolKind.LegacyIbmc;
