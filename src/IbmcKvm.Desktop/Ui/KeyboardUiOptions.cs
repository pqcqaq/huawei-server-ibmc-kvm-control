...
internal static class KeyboardUiOptions
{
    ...
    private static List<HidUsageOption> CreateCustomKeys()
    {
        ...
        options.AddRange(
        [
            new(0x28, "Enter"), new(0x29, "Esc"), new(0x2A, "Backspace"), new(0x2B, "Tab"),
            new(0x2C, "Space"), new(0x39, "Caps Lock"), new(0x46, "Print Screen"),
            new(0x47, "Scroll Lock"), new(0x48, "Pause"), new(0x49, "Insert"), new(0x4A, "Home"),
            new(0x4B, "Page Up"), new(0x4C, "Delete"), new(0x4D, "End"), new(0x4E, "Page Down"),
            new(0x4F, "Right"), new(0x50, "Left"), new(0x51, "Down"), new(0x52, "Up"),
            new(0x53, "Num Lock"), new(0x65, "Menu"), new(0x87, "JIS Ro"), new(0x89, "JIS Yen"),
            new(0x8A, "JIS Convert"), new(0x8B, "JIS NonConvert"),
        ]);
